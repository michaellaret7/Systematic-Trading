---
name: submit-pr
description: Run git diff, summarize changes, and submit a pull request to a target branch. Always authored as the user, never Codex.
---
...
- NEVER include "Generated with Codex" or any AI attribution
- NEVER mention Codex in the PR title or body
